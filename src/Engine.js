...
export class Engine {
	...
	/**
	 * @param {string} selectedLanguage the language used (javascript by default)
	 * @returns the test cases generated by Copilot
	 */
	async generateTests(selectedLanguage) {
		...
		const messages = [
			vscode.LanguageModelChatMessage.User(`You are a software engineer trying to create test cases in ${selectedLanguage} for a leetcode problem to test all general and edge cases.`),
